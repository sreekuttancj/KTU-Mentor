...
public class AboutUsActivity extends AppCompatActivity {
    ...
    public static String FACEBOOK_URL = "https://www.facebook.com/KTU-Mentor-1181801298527432";
    public static String FACEBOOK_PAGE_ID = "1181801298527432";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        relativeLayoutGooglePlus.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                openGPlus("117678568624711732449");
            }
        });
