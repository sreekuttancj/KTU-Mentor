...
class SyllabusInnerActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewPagerSyllabusAdapter = ViewPagerSyllabusAdapter(this@SyllabusInnerActivity)
        //get item and set in adapter
        //create observer
        syllabusViewModel.getSyllabusItem(position).observe(this, Observer { syllabusItem ->
            syllabusItem.let {
